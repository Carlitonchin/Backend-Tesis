    ...
    <Form class="mt-8 space-y-6 w-full" action="#" method="POST" @submit="handle_submit">
      ...
      <div class="-space-y-px rounded-md shadow-sm w-full">
        <div>
          ...
          class="relative block w-full appearance-none rounded-t-md border border-gray-300 px-3 py-2
      ...
      <div class="text-sm flex justify-center">
          <a href="signup" class="font-medium text-red-600 hover:text-red-500">¿No te haz registrado? Hazlo aquí</a>
        </div>
